...
public class Parking {
    ...
    public Parking(int id, String parkingName, String countrey, String city, String adress, double ppn, byte[] parkingImage, String status,String service, User user) {
        this.id = id;
    ...
    public Parking(String parkingName, String countrey, String city, String adress, double ppn, byte[] parkingImage,String service, String status, User user) {
        this.parkingName = parkingName;
        this.countrey = countrey;
        this.city = city;
        this.adress = adress;
